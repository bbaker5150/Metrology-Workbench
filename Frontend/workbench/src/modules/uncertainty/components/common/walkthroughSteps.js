...
export const createWalkthroughSteps = (sessionCount) => {
  ...
  return [
    ...
    step(
      ...
      "Enter a name, such as Torque, in the UUT table's Area name field and press Enter or +. Areas organize instruments and sidebar points with the same color; an instrument's Function remains library search metadata.",
    ...
    step(
      ...
      "Enter a name in the TMDE table's Area name field and press Enter or +, then use the area's wrench button to add an instrument. Search Description or enter the definition, and complete the ranges, tolerances, distributions, and resolution just as for a UUT.",
