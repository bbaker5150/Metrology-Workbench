    ...
    >
      <tbody className="component-group-tbody">
        {labeledComponents.map((component, componentIndex) => {
          if (component.dynamicDefinitionId) return <DynamicBudgetComponentRow key={component.id} component={component} referencePoint={component.dynamicReferencePoint || manualReferencePoint} showDof={showDof}
