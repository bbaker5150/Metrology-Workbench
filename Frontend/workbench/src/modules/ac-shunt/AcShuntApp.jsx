...
function AppContent() {
  ...
  const activeSettings = useMemo(() => {
    ...
    return {
      ...
      f5790_filter_mode: readSetting('f5790_filter_mode', 'FAST'),
      f5790_filter_restart: readSetting('f5790_filter_restart', 'COARSE'),
      f5790_hires_enabled: readSetting('f5790_hires_enabled', false),
      f5790_range_mode: readSetting('f5790_range_mode', 'POINT'),
      f5790_input_switch_settling_time: readSetting('f5790_input_switch_settling_time', 1),
